...
describe('favorite blogs', () => {
  test('of empty list is zero', () => {
    expect(listHelper.favoriteBlog(emptyBlogs)).toBe(0)
  })
  ...
  test('of a bigger list is shown the correct one', () => {
...
describe('author with most blogs', () => {
  test('of empty list is zero', () => {
    expect(listHelper.mostBlogs(emptyBlogs)).toBe(0)
  })

  test('when list has only one blog should match with that one', () => {
    const expectedResult = { author: 'Edsger W. Dijkstra', blogs: 1 }
    expect(listHelper.mostBlogs(oneBlog)).toEqual(expectedResult)
  })

  test('of a bigger list is shown the correct author with most blogs', () => {
...
describe('author with most likes', () => {
  ...
  test('when list has only one blog should match with that one', () => {
    ...
    expect(listHelper.mostLikes(oneBlog)).toEqual(expectedResult)
  })

  test('of a bigger list is shown the correct author with most likes', () => {
